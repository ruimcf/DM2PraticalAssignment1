...
As an attempt to retrieve more meaningful information, we decided to do some changes. The aditional time and space data was removed (Day of week, day, month, hour, police force) and the rule lenght was limited to 2.
```{r, echo=FALSE}

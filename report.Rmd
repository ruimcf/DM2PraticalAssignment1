...
data.discretized <- original.data[, !names(data) %in% useless]
...
With the Date attribute, year, month and day attributes were created.
With the Time attribute, hour and minute attributes were created.
